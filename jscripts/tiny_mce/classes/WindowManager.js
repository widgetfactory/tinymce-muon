...
(function (tinymce) {
    ...
    function decode(str) {
        return tinymce.DOM.decode(str).replace(/\\n/g, '\n');
    }
    ...
    tinymce.create('tinymce.WindowManager', {
        ...
        open: function (s, p) {
            var f = '',
                mo = this.editor.settings.dialog_type == 'modal',
         ...
         * });
         */
        confirm: function (title, cb, s, w) {
            w = w || window;

            cb.call(s || this, w.confirm(decode(this.editor.getLang(title, title))));
        },
        ...
        alert: function (tx, cb, s, w) {
            ...
            w.alert(decode(this.editor.getLang(tx, tx)));
